...
const WeatherDay = () => {
  ...
  console.log("data dang can", data);
  ...
  return (
    <div className="weatherDay">
      <div className="weatherDay-inner">
        <h2 className="info">
          <div className="name">UV index</div>
          <i className="fa-solid fa-sun"></i>
          <div className="number">{data.current?.uvi}</div>
        </h2>
        <h2 className="info">
          <div className="name">Wind Status</div>
          <i className="fa-solid fa-wind wind"></i>
          <div className="number">{`${
            Math.round(data.current?.wind_speed * 3.6 * 100) / 100
          } km/h`}</div>
        </h2>
        <h2 className="info">
          <div className="name">Sunrise & Sunset</div>
	...
	C23.08,15.88,22.99,15.64,22.99,15.36z"
            ...
            <div className="number">{timeFormat(data.current?.sunrise)}</div>
          </div>
	...
	c-0.19,0.2-0.42,0.3-0.69,0.3h-2.32c-0.26,0-0.48-0.1-0.66-0.29C22.99,15.99,22.9,15.75,22.9,15.47z"
            ...
            <div className="number">{timeFormat(data.current?.sunset)}</div>
          </div>
        </h2>
        <h2 className="info">
	...
	"
          ...
          <div className="number">{data.current?.humidity}</div>
        </h2>
        <h2 className="info">
        ...
        <h2 className="info">
          ...
          <div className="number">{data.current?.pressure}</div>
        </h2>
      </div>
    </div>
  );
